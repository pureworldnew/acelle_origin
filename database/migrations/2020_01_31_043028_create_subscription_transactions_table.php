...
class CreateSubscriptionTransactionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        \Acelle\Model\Subscription::whereRaw('true')->delete();
        ...
        Schema::create('subscription_transactions', function (Blueprint $table) {
            ...
            $table->foreign('subscription_id', table('st_subscription_id_fk'))->references('id')->on('subscriptions')->onDelete('cascade');
        });
    }
