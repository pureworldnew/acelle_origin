                            ...
                            >
								@foreach ($admins as $key => $item)
									<tr>
										...
										<td class="text-right">
											@can('loginAs', $item)
												<a href="{{ action('Admin\AdminController@loginAs', $item->uid) }}" data-popup="tooltip" title="{{ trans('messages.login_as_this_admin') }}" type="button" class="btn bg-teal-600 btn-icon"><i class="icon icon-enter"></i></a>
											@endcan
											@can('update', $item)
